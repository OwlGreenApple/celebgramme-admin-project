    ...
    <tr class="row{{$data_arr->id}}">
      ...
      <td align="center">
        ...
        <!--<input type="button" class="btn btn-info btn-daily-like" value="+ likes" data-toggle="modal" data-target="#myModalDailyLikes" data-id="{{$data_arr->id}}" >-->
				...
				<?php } ?>
        <input type="button" class="btn btn-info btn-max-account" value="Max account" data-toggle="modal" data-target="#myModalMaxAccount" data-id="{{$data_arr->id}}" data-account="{{$data_arr->max_account}}">
        <input type="button" class="btn btn-info btn-edit-email" value="Email" data-toggle="modal" data-target="#myModalEditEmail" data-id="{{$data_arr->id}}" data-email="{{$data_arr->email}}"> 
