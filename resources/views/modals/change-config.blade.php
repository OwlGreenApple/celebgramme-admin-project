        ...
        <div class="modal-body">
          <form enctype="multipart/form-data" id="form-edit-config">
            ...
            <div class="form-group form-group-sm row">
              ...
              <div class="col-xs-2 col-sm-2 col-md-2">
                <input type="number" class="form-control" placeholder="" name="minute_check_auto_like_celebfans_min" value="{{Meta::getMeta('minute_check_auto_like_celebfans_min')}}">
              </div>
              <label class="col-xs-2 col-sm-2 col-md-2 control-label" for="">
							Minute check(auto like celebfans) max
							</label>
              <div class="col-xs-2 col-sm-2 col-md-2">
